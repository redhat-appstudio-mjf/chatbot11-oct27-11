...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot11-oct27-11`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot11-oct27-11-notebook`.
...
5) In the terminal, run `cd chatbot11-oct27-11` to navigate to your sample app's directory.
