...
!!! info
    ...
    **Source Code Repository:** [https://github.com/redhat-appstudio-mjf/chatbot11-oct27-11](https://github.com/redhat-appstudio-mjf/chatbot11-oct27-11)

    **GitOps Repository:** [https://github.com/redhat-appstudio-mjf/chatbot11-oct27-11-gitops](https://github.com/redhat-appstudio-mjf/chatbot11-oct27-11-gitops)

# **Usage**

To access the chatbot11-oct27-11 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of chatbot11-oct27-11. You can access this namespace through the web console or via your CLI.
